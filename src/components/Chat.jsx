      ...
      <ul className="nav flex-column nav-pills nav-fill px-2">
        ...
        <li className="nav-item w-100">
          <div role="group" className="d-flex dropdown btn-group">
            ...
            <div x-placement="bottom-start" aria-labelledby="" className="dropdown-menu" style={{position: 'absolute', top: 0 + 'px', left: 0 + 'px', margin: 0 + 'px', opacity: 0, pointerEvents: 'none'}} wfd-invisible="true">
    ...
    <div className="col p-0 h-100">
      <div className="d-flex flex-column h-100">
        ...
        <div id="messages-box" className="chat-messages overflow-auto px-5 ">
          <div className="text-break mb-2"><b>conarti</b>: 123</div>
          <div className="text-break mb-2"><b>Саня</b>: Привет</div>
          <div className="text-break mb-2"><b>conarti</b>: qq</div>
        </div>
